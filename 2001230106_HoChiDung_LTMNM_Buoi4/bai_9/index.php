<?php
require '../bai_1/connect.php';

// Lấy từ khóa tìm kiếm và thiết lập phân trang
$keyword = isset($_GET['keyword']) ? trim($_GET['keyword']) : '';
$limit = 5;
$page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
$offset = ($page - 1) * $limit;

// Tính tổng số bản ghi để tạo chỉ mục phân trang
...
// Truy vấn dữ liệu sinh viên theo từ khóa và phân trang
