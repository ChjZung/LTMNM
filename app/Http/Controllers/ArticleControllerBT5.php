...
class ArticleControllerBT5 extends Controller
{
    public function index()
    {
        ...
        return view('bt5.articles.index', compact('articles'));
    }

    public function create()
    {
        return view('bt5.articles.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bt5.articles.index')
    ...
    public function edit(string $id)
    {
        ...
        return view('bt5.articles.edit', compact('article'));
    }
