...
class ArticleControllerBT2 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('bt2.articles.index', compact('articles'));
    }
    ...
    {
        return view('bt2.articles.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bt2.articles.index')
    ...
    public function edit(string $id)
    {
        ...
        return view('bt2.articles.edit', compact('article'));
    }
