...
<form action="{{ route('bt5.articles.update',$article['id']) }}" method="post">
@csrf
@method('PUT')
...
@enderror
<button type="submit" style="margin-top:10px;padding:6px 16px;background:#2563eb;color:#fff;border:none;border-radius:4px;cursor:pointer">Cập nhật</button>
</form>
@endsection
